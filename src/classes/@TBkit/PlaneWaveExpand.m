...
%   H_hk_out = PLANEWAVEEXPAND(H_hk, N, ExpandDirection) expands the
%   Hamiltonian in plane wave basis up to order N in specified directions.
%
%   Inputs:
%       H_hk          - Input HK object
%       N             - Expansion order (default: 5)
%       ExpandDirection - Directions to expand [1/0 for x/y/z] (default: [1 1 0])
%
%   Output:
%       H_hk_out      - Expanded HK object
%
%   See also HK
arguments
    H_hk HK;
