...
%SORTEIG Sort eigenvalues and eigenvectors
%
%   Syntax:
%       [Asort,Usort] = sorteig(U,A)
%
%   Description:
%       Sorts eigenvalues in descending order and corresponding eigenvectors.
%       Handles both full matrices and vector eigenvalue inputs.
%
%   Inputs:
%       U - Eigenvalue matrix or vector
%       A - Eigenvector matrix (optional)
%
%   Outputs:
%       Asort - Sorted eigenvectors (if A provided)
%       Usort - Sorted eigenvalues
%
%   See also: eig, eigs
if nargin <2
    mode = 'eigenval';
