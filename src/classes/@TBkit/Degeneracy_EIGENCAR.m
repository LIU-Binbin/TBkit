...
%DEGENERACY_EIGENCAR Identify degenerate states in eigenvalue arrays
%
%   Syntax:
%       [DEGENCAR, NODEINSECT] = Degeneracy_EIGENCAR(EIGENCAR,highK,dE)
%
%   Description:
%       Analyzes eigenvalue arrays to identify degenerate states and their
%       connectivity between high-symmetry points in the Brillouin zone.
%
%   Inputs:
%       EIGENCAR - Eigenvalue array (bands × k-points)
%       highK    - Indices of high-symmetry k-points
%       dE       - Energy tolerance for degeneracy (default=0.1)
%
%   Outputs:
%       DEGENCAR   - Degeneracy count at high-symmetry points
%       NODEINSECT - Connectivity of degenerate states between high-K points
%
%   See also: EIGENSOLVE, checkDegen
if nargin <3
    dE =0.1;
end
