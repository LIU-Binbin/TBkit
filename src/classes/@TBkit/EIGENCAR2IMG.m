...
%EIGENCAR2IMG Convert eigenvalue array to sparse image representation
%
%   Syntax:
%       IMG = EIGENCAR2IMG(EIGENCAR,dE,Erange,kselect)
%
%   Description:
%       Creates a 2D sparse matrix representation of band structure data
%       for visualization and similarity comparison purposes.
%
%   Inputs:
%       EIGENCAR - Eigenvalue array (bands × k-points)
%       dE       - Energy bin width (default=0.1)
%       Erange   - Energy range [min,max] (default=auto)
%       kselect  - Selected k-point indices (default=all)
%
%   Output:
%       IMG - Sparse image matrix of band structure
%
%   See also: EIGENCAR_Value, arrangeEIGENCAR
