function C = plus(A,B)
%PLUS Addition operation for HK objects
%   C = PLUS(A, B) performs addition between HK objects or between
%   HK object and Term/Trig/symbolic objects.
%
%   Inputs:
%       A - First operand (HK object or Term/Trig/sym)
%       B - Second operand (HK object or Term/Trig/sym)
%
%   Output:
%       C - Result of addition operation
%
%   See also HK, MINUS
