...
%EIGENCAR_GEN Generate eigenvalue spectrum from Hamiltonian
%   [EIGENCAR, WAVECAR] = EIGENCAR_gen(H_hk, options) computes eigenvalues
%   and eigenvectors for a k-space Hamiltonian on specified k-points.
%
%   Inputs:
%       H_hk    - HK object containing Hamiltonian
%       options - Optional parameters:
%           .fermi      : Fermi level for eigs (default: 0)
%           .norb       : Number of bands to compute (default: all)
%           .klist      : k-points to evaluate (default: H_hk.klist_cart)
%           .show       : Visualize k-points (default: false)
%           .OriginGk   : Origin shift (default: [0 0 0])
%
%   Outputs:
%       EIGENCAR - Eigenvalue spectrum (NBANDS x Nk)
%       WAVECAR  - Corresponding eigenvectors
%
%   Example:
%       [E, W] = EIGENCAR_gen(H, 'fermi', 0.5, 'norb', 10);
    arguments
        H_hk HK;
