...
%KLOOP1D Generate circular k-path around a point
%   [k_cart, k_frac] = kloop1D(kpt, normal, r, opts)
%
%   Inputs:
%       kpoint_frac - Center point (fractional or cartesian)
%       Orientation - Loop normal vector
%       radius      - Loop radius
%       opt         - Options:
%           .nk            - Number of points (default: 100)
%           .Gk            - Reciprocal lattice vectors
%           .inputCar      - Input in cartesian coords (default: false)
%           .theta_0       - Starting angle (default: 0)
%           .anticlockwise - Loop direction (default: true)
%
%   Outputs:
%       klist_cart - Cartesian coordinates
%       klist_frac - Fractional coordinates
arguments
    kpoint_frac;
    Orientation = [0,0,1];
    radius = 0.01;
