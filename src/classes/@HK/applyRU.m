...
%APPLYRU Apply combined rotation and unitary transformation
%
% Syntax:
...
%   SymOper - Symmetry operation (Oper object)
%
% Outputs:
%   H_hk_R - Transformed Hamiltonian
%   H_hk - Original Hamiltonian (for reference)
%
% Description:
%   Applies combined spatial rotation (R) and unitary transformation (U)
%   to the Hamiltonian. Handles conjugate operations and antisymmetry
%   requirements. The transformation follows:
%   H'(k) = U·H(R^-1·k)·U^-1 (with possible conjugation/antisymmetry)
