%% useful_tools
function useful_matrices(InputStrlist,options)
arguments
    InputStrlist = ["sigma","tau","s","pauli","Gamma","Gell-Mann"];
    options.mode {mustBeMember(options.mode,{'double','sym','pauli_matrix'})} = 'pauli_matrix';
end
F = eval(['@',options.mode]);

sigma_0 = F(pauli_matrix(0));
sigma_x = F(pauli_matrix(1));
sigma_y = F(pauli_matrix(2));
sigma_z = F(pauli_matrix(3));

Gamma_0 = F(gamma_matrix(0));
Gamma_1 = F(gamma_matrix(1));
Gamma_2 = F(gamma_matrix(2));
Gamma_3 = F(gamma_matrix(3));
Gamma_4 = F(gamma_matrix(4));
Gamma_5 = F(gamma_matrix(5));
Gamma_12 = F(gamma_matrix(1,2));
Gamma_13 = F(gamma_matrix(1,3));
Gamma_14 = F(gamma_matrix(1,4));
Gamma_15 = F(gamma_matrix(1,5));
Gamma_23 = F(gamma_matrix(2,3));
Gamma_24 = F(gamma_matrix(2,4));
Gamma_25 = F(gamma_matrix(2,5));
Gamma_34 = F(gamma_matrix(3,4));
Gamma_35 = F(gamma_matrix(3,5));
Gamma_45 = F(gamma_matrix(4,5));
