...
[klist_cart, klist_frac] = kcubegen3D('Rm', H_kp_n.Rm, 'KCUBE_BULK', kcube_bulk, 'nk', [100 100 100]);

mu_list = linspace(-0.2, 0.2, 201);
%%
alpha_mu = NCTE(H_kp_n, [1 2 3], klist_cart, mu_list, 'ncore',4 , 'T',20,'batch_size',1e6);
% ~ 6min
