...
[H_1D.klist_cart,H_1D.klist_frac,klist_l,kpoints_l,~] = ...
    TBkit.kpathgen([-0.5;0;0;0.5],60,H_1D.Gk,'Dim',1);
t = -1;
H_1D_n = H_1D.Subsall;
EIGENCAR = H_1D_n.EIGENCAR_gen();
bandplot(EIGENCAR,[-1,1],klist_l,kpoints_l,["-\pi","0","\pi"],'Color','r','title','Dim = 1 (Htrig)');
%%
H_1D.orbL = [0];
...
bandplot(EIGENCAR,[-1,1],klist_l,kpoints_l,["-\pi","0","\pi"],'Color','r','title','Dim = 1 (HR)');

%% **************** 2D **************** 
syms t lambda k_x k_y real;
useful_matrices("sigma",'mode','sym');
...
bandplot(EIGENCAR,[-3,3],klist_l,kpoints_l,["\Gamma","M","K","\Gamma"],'Color','r','title','Dim = 2 (HR)');
%%
...
% EIGENCAR = H_KaneMele_n.EIGENCAR_gen();
% bandplot(EIGENCAR,[-3,3],klist_l,kpoints_l,["\Gamma","M","K","\Gamma"],'Color','r','title','Dim = 3 (HR)');
