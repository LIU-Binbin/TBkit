...
KaneMele = KaneMele+...
    ...
    Trig(4*lambda_SO*sin(q_x)*(cos(q_x)-cos(q_y)),gamma_matrix(1,5))+...
    Trig(lambda_R*(1-cos(q_x)*cos(q_y))          ,gamma_matrix(4  ))+...
    Trig(-sqrt(3)*lambda_R*sin(q_x)*sin(q_y)     ,gamma_matrix(2  ))+...
    Trig(-lambda_R*cos(q_x)*sin(q_y)             ,gamma_matrix(3,4))+...
    Trig(sqrt(3)*lambda_R*sin(q_x)*cos(q_y)      ,gamma_matrix(3,2))+...
